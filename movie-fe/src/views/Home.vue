        ...
        <div class="card">
          <div class="row">
            ...
            <div class="col-md-6 d-md-none">
              <img :src="require('@/assets/movie_logo.jpg')" class="img-fluid" alt="Responsive image" style="height: 20rem"/>
            </div>
            <div class="col-md-6">
              <div class="card-body">
                <h5 class="card-title">Movies</h5>
                <p class="card-text">
                  View descriptions and ratings of movies you are interested in watching.
                </p>
